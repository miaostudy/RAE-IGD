...
```shell
python IGD/sample_mp.py --model DiT-XL/2 --image-size 256 --ckpt pretrained_models/0012000.pt \
    --save-dir "./results/dit-distillation/nette-10-minimax-igd-ckpts-resnet-k10-gamma100-r1-gi200-low30-high45" --data-path /data/wlf/datasets/imagenette/train \
    --spec nette --gm-scale 10 --grad-ipc 10 --net-type resnet --depth 10 \
    --low 30 --high 45 --ckpt_path ckpts --repeat 1 --num-samples 50 --dev-scale 100 \
